...
export async function sendUsdcViaWalletsApi(args) {
    const apiKey = (args.runtime ? envSetting(args.runtime, "CIRCLE_API_KEY") : undefined) ??
        process.env.CIRCLE_API_KEY;
    const entitySecret = (args.runtime ? envSetting(args.runtime, "ENTITY_SECRET") : undefined) ??
    ...
    const client = init({ apiKey, entitySecret });
...
//# sourceMappingURL=sendUsdc.js.map