...
let cachedKit: CircleAgentKit | undefined;
export function kitFromEnv(): CircleAgentKit {
  if (!cachedKit) cachedKit = CircleAgentKit.create();
  return cachedKit;
}
...
export const circleTools: CircleTool[] = [
  {
  ...
  },
  {
    ...
    description:
      "Request free testnet USDC (and native gas when needed) from the Circle faucet API. Testnet only.",
    parameters: obj(
      {
  ...
  },
  {
    ...
    description:
      "Send USDC from an agent wallet to a destination address. Mainnet or large transfers require confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  },
  {
    ...
    run: (kit, p) =>
      kit.payX402(resolvePaywallUrl(p.url), { method: p.method, body: p.body }),
  },
  {
    ...
    optional: true,
    parameters: obj(
      { amount: str("USDC amount to deposit."), confirm: bool("Explicit confirmation.") },
      ["amount"]
    ),
  ...
  // --- Contracts / Bridge / Swap (SDK-native, dev-controlled wallet) ------
  {
    ...
    description:
      "Execute a write function on a smart contract from a dev-controlled wallet (SDK-native). Requires confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  },
  {
    ...
    description:
      "Bridge USDC across chains via CCTP v2 using dev-controlled wallets (approve -> burn -> attest -> mint). Mainnet/large amounts require confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  },
  {
    name: "circle_swap",
    description:
      "Swap one token for another from a dev-controlled wallet (SDK-native, via configured DEX aggregator). sellAmount is base units. Mainnet/large swaps require confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  // --- Agent Stack (Circle CLI) — user-custody agent wallets --------------
  {
    ...
    description:
      "Start Circle Agent Wallet authentication: send a one-time password (OTP) to an email; returns a request id.",
  ...
  },
  {
    ...
    description:
      "Complete Circle Agent Wallet authentication with the request id and OTP. Provisions wallets on all chains.",
    parameters: obj(
      { requestId: str("Request id from login init."), otp: str("OTP code from the inbox.") },
      ["requestId", "otp"]
    ),
  ...
  },
  {
    ...
    description:
      "Fund an agent wallet. Testnet draws from the Circle faucet (omit amount/method). Mainnet crypto/fiat requires confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  },
  {
    ...
    description:
      "Transfer USDC (or token) from an agent wallet via the Circle CLI. Mainnet/large transfers require confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  },
  {
    ...
    parameters: obj(
      { toChain: str("Destination chain id."), fromChain: str("Source chain id (default configured).") },
      ["toChain"]
    ),
  ...
  },
  {
    ...
    description:
      "Bridge USDC across chains via CCTP (burn on source, mint on destination). Mainnet/large amounts require confirm=true.",
    optional: true,
    parameters: obj(
      {
        toChain: str("Destination chain id."),
  ...
  },
  {
    ...
    parameters: obj(
      { txHash: str("Burn transaction hash (0x...)."), fromChain: str("Source chain id.") },
      ["txHash"]
    ),
  ...
  },
  {
    ...
    description:
      "Swap one token for another from an agent wallet with a buyMin stop-limit. Mainnet/large swaps require confirm=true.",
    optional: true,
    parameters: obj(
      {
  ...
  },
  {
    ...
    parameters: obj(
      { name: str("Contract name, e.g. usdc, cctp, gateway."), chain: str("Chain id.") },
      ["name"]
    ),
  ...
  },
  {
    ...
    description:
      "Execute a write function on a smart contract from an agent wallet. Always requires confirm=true.",
    optional: true,
    parameters: obj(
      {
